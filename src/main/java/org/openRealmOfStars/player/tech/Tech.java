...
public class Tech {
   ...
   * @param level Tech level 1-max (can be extended beyond 10)
   */
  ...
  /**
   * Get Tech Level.
   * @return int between 1-max (can be extended beyond 10)
   */
  public int getLevel() {
    return level;
  }
  ...
  /**
   * Set Tech level
   * @param level between 1-max (can be extended beyond 10, up to 50)
   */
